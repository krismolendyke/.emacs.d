...
** Emacs Source Directory
   ...
   =source-directory= is helpful to have set properly when interested in
   exploring built-in /C functions/ via =find-function=.
...
** TODO Investigate [[http://hunspell.sourceforge.net/][=hunspell=]]
